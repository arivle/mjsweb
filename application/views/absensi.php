									...
									<td>
										<div class="table-data-feature">
											<button class="item"
													...
													data-target="#editData-<?= $a->idAbsensi ?>">
												<i class="zmdi zmdi-edit"></i>
											</button>
											<button class="item" data-toggle="tooltip" data-placement="top"
													title="Delete"
													onclick="window.location.href='<?= base_url() . "absensi/hapus/" . $a->idAbsensi ?>'">
	...
	<div class="modal-dialog modal-md" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="<?= base_url() ?>Absensi/tambahManual" id="formTambahData" method="post"
					...
					<div class="row form-group">
						...
						<div class="col-12 col-md-9">
							<input type="date" id="tanggal-input" name="tanggal-input" placeholder=""
								   class="form-control">
						</div>
					</div>
					<div class="row form-group">
						...
						<div class="col-12 col-md-9">
							<div class="input-group clockpicker">
								<input type="text" class="form-control" name="masuk-input" value="00:00">
							</div>
						</div>
					</div>
					<div class="row form-group">
						...
						<div class="col-12 col-md-9">
							<div class="input-group clockpicker">
								<input type="text" class="form-control" name="keluar-input" value="00:00">
							</div>
						</div>
					</div>
					<div class="row form-group">
						...
						<div class="col-12 col-md-9">
							<textarea name="keterangan-input" id="keterangan-input" rows="9"
									  placeholder="Masukkan keterangan..." class="form-control"></textarea>
						</div>
					</div>
				</form>
			</div>
...
<?php foreach ($absensi as $a) { ?>
	<!-- modal edit -->
	<div class="modal fade" id="editData-<?= $a->idAbsensi ?>" tabindex="-1" role="dialog" aria-labelledby="mediumModalLabel"
		 aria-hidden="true">
		<div class="modal-dialog modal-md" role="document">
			<div class="modal-content">
				<div class="modal-header">
				...
				<div class="modal-body">
					<form action="<?= base_url() ?>Absensi/edit" id="formEditData-<?=$a->idAbsensi?>" method="post"
						...
						<div class="row form-group">
							...
							<div class="col-12 col-md-9">
								<select name="pegawai-select" id="pegawai-select" class="form-control">
									...
									foreach ($pegawai as $p) {
									?>
										<option value="<?=$p->id?>" <?= $p->id == $a->idPegawai?'selected':'' ?>> <?=$p->first_name . " " . $p->last_name?></option>
									<?php
									}
									unset($p);
									?>
						...
						<div class="row form-group">
							...
							<div class="col-12 col-md-9">
								<div class="input-group clockpicker">
									<input type="text" class="form-control" name="masuk-input" value="<?=$a->waktuMasuk?>">
								</div>
							</div>
						</div>
						<div class="row form-group">
							...
							<div class="col-12 col-md-9">
								<div class="input-group clockpicker">
									<input type="text" class="form-control" name="keluar-input" value="<?=$a->waktuKeluar?>">
								</div>
							</div>
						</div>
						<div class="row form-group">
							...
							<div class="col-12 col-md-9">
								<textarea name="keterangan-input" id="keterangan-input" rows="9"
										  placeholder="Masukkan keterangan..." class="form-control"><?= $a->keterangan ?></textarea>
							</div>
						</div>
					</form>
				</div>
