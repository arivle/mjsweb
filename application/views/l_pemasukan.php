...
echo "\n"; 
echo "    <!-- Title Page-->\n"; 
echo "    <title>Laporan Pemasukan</title>\n"; 
echo "\n"; 
echo "    <!-- Fontfaces CSS-->\n"; 
...
echo "                                        <i class=\"active fas fa-chart-bar\"></i>Laporan Pemasukan</a>\n"; 
echo "                                </li>\n"; 
echo "                                <li>\n"; 
echo "                                    <a href=\"chart.html\">\n"; 
echo "                                        <i class=\"fas fa-chart-bar\"></i>Laporan Pengeluaran</a>\n"; 
echo "                                </li>\n"; 
echo "\n"; 
echo "                            </ul>\n"; 
echo "                        </li>\n"; 
...
echo "                                <h3 class=\"title-5 m-b-35\">Laporan Pemasukan - latest</h3>\n"; 
...
echo "                                            <div class=\"icon\">\n"; 
echo "                                                <i class=\"zmdi zmdi-money\"></i>\n"; 
echo "                                            </div>\n"; 
echo "                                            <div class=\"text\">\n"; 
echo "                                                <h2>$1,060,386</h2>\n"; 
echo "                                                <span>total pemasukan</span>\n"; 
echo "                                            </div>\n"; 
echo "                                        </div>\n"; 
echo "                                        <div class=\"overview-chart\">\n"; 
echo "                                            <canvas id=\"widgetChart4\"></canvas>\n"; 
echo "                                        </div>\n"; 
echo "                                    </div>\n"; 
echo "                                </div>\n"; 
echo "                            </div>\n"; 
echo "                        </div>\n"; 
echo "                        <!-- RINCIAN PEMASUKAN -->\n"; 
echo "                        <div class=\"row m-t-30\">\n"; 
echo "                            <div class=\"col-md-12\">\n"; 
echo "                                <h3 class=\"title-5 m-b-35\">Rincian Pemasukan</h3>\n"; 
...
echo "                                                <th>terima dari</th>\n"; 
echo "                                            </tr>\n"; 
echo "                                        </thead>\n"; 
echo "                                        <tbody>\n"; 
echo "                                            <tr class=\"tr-shadow\">\n"; 
echo "                                                <td>1113</td>\n"; 
echo "                                                <td>2017-12-05 10:12</td>\n"; 
echo "                                                <td class=\"desc\">Pinjaman Bank ABC</td>\n"; 
echo "                                                <td>Pinjaman</td>\n"; 
