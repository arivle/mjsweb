                            ...
                            <div class="noti-wrap">
                                ...
                                <div class="noti__item js-item-menu">
                                    ...
                                    <div class="email-dropdown js-dropdown">
                                        ...
                                        <div class="email__item">
                                            <div class="<?php echo base_url();?>assets/image img-cir img-40">
                                                ...
                                                <div class="au-message__item-inner">
                                                    <div class="au-message__item-text">
                                                        <div class="avatar-wrap online">
                                                            <div class="avatar">
                                                                <img src="<?php echo base_url();?>assets/images/icon/avatar-03.jpg"
                                            ...
                                            <div class="au-message__item">
                                                <div class="au-message__item-inner">
                                                    <div class="au-message__item-text">
                                                        <div class="avatar-wrap online">
                                                            <div class="avatar">
                                                                <img src="<?php echo base_url();?>assets/images/icon/avatar-04.jpg"
                                                                     alt="Michelle Sims">
                                                            </div>
                                                        </div>
                                                        <div class="text">
                                            ...
                                            <div class="au-message__item">
                                                <div class="au-message__item-inner">
                                                    <div class="au-message__item-text">
                                                        <div class="avatar-wrap">
                                                            <div class="avatar">
                                                                <img src="<?php echo base_url();?>assets/images/icon/avatar-05.jpg"
                                                                     alt="Michelle Sims">
                                                            </div>
                                                        </div>
                                                        <div class="text">
