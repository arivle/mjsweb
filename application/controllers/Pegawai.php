...
class Pegawai extends CI_Controller
{
	...
	public function list_users()
	{
		...
		$this->_render_page('pegawai',$this->data);
	}
	...
	{
		$this->data['title'] = 'Login - Selamat Datang di MJS';
		// validasi
		$this->form_validation->set_rules('email', 'Email', 'required');
		$this->form_validation->set_rules('remember', 'Remember Me', 'integer');
		if ($this->form_validation->run() == true) {
			// cek masih login ga? (remember me)
	...
	public function create_user()
	{
		...
		if ($this->form_validation->run() === true && $this->ion_auth->register($username, $password, $email, $additional_data, $group_ids)) {
            ...
            echo "DONEE";
			$this->session->set_flashdata('message', $this->ion_auth->messages());
//			redirect("pegawai/list_users", 'refresh');
		} else {
...
//            $this->_render_page('pegawai',$this->data);
...

	{
        ...
        $this->load->view('template/mobile_header', $this->viewdata);
        $this->load->view('template/desktop_header', $this->viewdata);
        $this->load->view('template/header_content', $this->viewdata);
        $this->load->view('pegawai', $this->viewdata);
        $this->load->view('template/footer');
	}
