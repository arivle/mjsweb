...
CREATE TABLE `klien`  (
  `idKlien` varchar(10) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
...
CREATE TABLE `proyek`  (
  ...
  `idKlien` varchar(10) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL,
  ...
  CONSTRAINT `proyek_ibfk_1` FOREIGN KEY (`idKlien`) REFERENCES `klien` (`idKlien`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
-- Records of users
-- ----------------------------
INSERT INTO `users` VALUES (1, '127.0.0.1', 'administrator', '$2a$07$SeBknntpZror9uyftVopmu61qg0ms8Qv1yV6FG.kQOSM.9QhmTo36', '', 'admin@admin.com', '', NULL, NULL, '.kXHPvkubbQ7jdcEa2K1Ze', 1268889823, 1530705456, 1, 'Admin', 'istrator', 'ADMIN', '0');
